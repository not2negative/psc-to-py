Algoritmo ejercicio17
	...
	Escribir "Tiene un nivel de inglés intermedio? (Escriba verdadero o falso)"
	Leer ingles_intermedio
	// Proceso y salida
	Si puntaje_admision >= 700 y faltas_disciplinarias = Falso y ingles_intermedio = Verdadero Entonces
		Escribir "Usted cumple las condiciones solicitadas para la selección universitaria"
	SiNo
		Escribir "Usted no cumple las condiciones solicitadas para la selección universitaria"
	FinSi
FinAlgoritmo
